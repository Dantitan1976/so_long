...
void	ft_error_solong(t_list_solong *d, int error)
{
	...
	if (error == 1)
		ft_printf("\033[0;91m\nNo hay pared al principio de la línea.\033[0;39m\n");
	if (error == 2)
		ft_printf("\033[0;91m\nNo hay pared al final de la línea.\033[0;39m\n");
	if (error == 3)
		ft_printf("\033[0;91m\nNo hay pared en la primera línea.\033[0;39m\n");
	if (error == 4)
		ft_printf("\033[0;91m\nNo hay pared en la última línea.\033[0;39m\n");
